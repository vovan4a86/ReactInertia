...
//images
import profile from '/public/images/logo192.png';

// styles
import useStyles from './styles';

// components
import { Typography, Avatar, Link } from '../Wrappers/Wrappers';
...
export default function Header({ title, user, onToggleSidebar }) {
    ...
    const handleToggleSidebar = () => {
        toggleSidebar(layoutDispatch); // Меняем LayoutContext
        if (onToggleSidebar) {
            onToggleSidebar(); // Вызываем переданный из AdminLayout колбэк
        }
    };
