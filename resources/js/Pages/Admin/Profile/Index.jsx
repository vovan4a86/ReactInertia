...
import { useTheme } from "@admin-layouts/mui";

import { Badge, Chip, Button } from '@admin-components/Wrappers/Wrappers.jsx';
...
Profile.layout = (page) => <AdminLayout title="Профиль администратора">{page}</AdminLayout>;
