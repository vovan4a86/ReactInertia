...
import {
    ...
    IconButton, Menu
        ...
        "@mui/material";
import {useTheme, makeStyles} from '@admin-layouts/mui';
import {
    ResponsiveContainer,
    ComposedChart,
    AreaChart,
...
import {Chip, Typography, Avatar} from "@admin-components/Wrappers/Wrappers";
import Dot from "@admin-components/Sidebar/components/Dot";
                ...
                {headCells.map((headCell) =>
                    <TableCell
                        ...
                        <TableSortLabel
                            ...
                            <Typography uppercase color="text" variant={"body2"}
                                        colorBrightness="hint">{headCell.label}</Typography>
                            {orderBy === headCell.id ?
